...
', NULL);
INSERT INTO question VALUES (4, '2017-06-23 12:29:00', 531, 102, 'How to execute large amount of sql queries asynchronous and in threads', 'Problem: I have huge amount of sql queries (around 10k-20k) and I want to run them asynchronous in 50 (or more) threads.
...
INSERT INTO question VALUES (5, '2018-01-13 06:45:00', 21, -21, 'Hide Location toolbar from IONIC Native InAppBrowser', 'Reading the cordova documentation inappbrowser I can not find a way to hide the Location Toolbar (ALWAYS AND WHEN it has ""location = yes"") and just for Android, becouse we can use ""toolbar=no"" on IOs.
...
INSERT  INTO  question VALUES (6, '2019-08-08 23:59:00', 67, -2, 'My windows seems to be outdated', 'Pls help, do I have to update Windows?', 'windows.jpg');
INSERT  INTO  question VALUES (7, '2019-08-09 10:12:00', 10, 0, 'What to do now (git)?', 'I have no idea what to do with this:', 'git.jpg');
INSERT  INTO  question VALUES (8, '2019-08-22 14:12:11', 1234, 5678, 'How will we survive after Dani and Menta are gone?!', 'We are REALLY AFRAID of it and this is happening NOW! :(', 'dani.jpg');
...
INSERT INTO answer VALUES (3, '2019-08-09 00:03:00', 60, 6, 'Rofl, put it right into the garbage and use Linux!', NULL);
INSERT INTO answer VALUES (4, '2019-08-09 00:05:00', 0, 7, 'I don''t know :(', NULL);
INSERT INTO answer VALUES (5, '2019-08-09 00:09:00', 10, 7, 'Just resolve the conflict. EZPZ', NULL);
INSERT INTO answer VALUES (6, '2019-08-09 00:18:00', 5, 7, 'Try this:', 'merge.jpg');
INSERT INTO answer VALUES (7,'2019-08-09 00:45:00', 1507, 6,'░░░░▄▄▄▄▀▀▀▀▀▀▀▀▄▄▄▄▄▄
░░░░█░░░░▒▒▒▒▒▒▒▒▒▒▒▒░░▀▀▄
░░░█░░░▒▒▒▒▒▒░░░░░░░░▒▒▒░░█
░░█░░░░░░▄██▀▄▄░░░░░▄▄▄░░░█
░▀▒▄▄▄▒░█▀▀▀▀▄▄█░░░██▄▄█░░░█
...
░░░░░░░░░░▀▀▄▄░▒▒▒▒▒▒▒▒▒▒░█
░░░░░░░░░░░░░░▀▄▄▄▄▄░░░░░█', NULL);
INSERT INTO answer VALUES (8, '2019-08-22 15:18:00', 5, 8, 'Try this: keep in touch! invite them regularly to VISIT Codecool! Make them missing us SO much, that they would come anyway :D', NULL);
...
INSERT INTO comment VALUES (3, 7, NULL, 'Wow! It looks terrifying', '2019-08-09 00:11:00');
...
INSERT INTO comment VALUES (6, 8, NULL, 'OOH sh_t... you can''t say it is true!', '2019-08-22 14:48:00');
...
INSERT INTO user_info VALUES (1, 'foxi88', '$2b$12$mfNs1INx723d7nFXOQwPYOL4iyloBHbf5UZJVR/rweywMqmRKqtiO','2019-08-20 12:00:04');
...
INSERT INTO user_question VALUES (2, 1);
INSERT INTO user_question VALUES (3, 1);
INSERT INTO user_question VALUES (4, 2);
INSERT INTO user_question VALUES (5, 2);
INSERT INTO user_question VALUES (6, 2);
INSERT INTO user_question VALUES (7, 1);
INSERT INTO user_question VALUES (8, 1);
INSERT INTO user_answer VALUES (1, 2);
INSERT INTO user_answer VALUES (2, 2);
INSERT INTO user_answer VALUES (3, 2);
INSERT INTO user_answer VALUES (4, 1);
...
INSERT INTO user_comment VALUES (3, 2);
INSERT INTO user_comment VALUES (4, 2);
INSERT INTO user_comment VALUES (5, 1);
INSERT INTO user_comment VALUES (6, 2);
